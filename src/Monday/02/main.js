...
// 1. Получить список персонажей из "Гарри Поттера" и их дома -> результат вывести в формате имя-дом:
 for(const character in harryPotterCharacters){
     // console.log(harryPotterCharacters[character].name + '-' + harryPotterCharacters[character].house)
 }
// 2. Получить список имен персонажей из "Гарри Поттера" с их возрастом:
for(const character in harryPotterCharacters){
    // console.log(harryPotterCharacters[character].name + '-' + harryPotterCharacters[character].age)
}
// **3. Получить список имен питомцев персонажей из "Гарри Поттера":
for(const petNames in harryPotterCharacters){
    // console.log(harryPotterCharacters[petNames].pet.name)
}
